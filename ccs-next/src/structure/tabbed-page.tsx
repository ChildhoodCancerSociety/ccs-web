...
import { classNames } from "ccs@util/style";
import { NullComponent } from "ccs@util/helpers";
...
const TabbedPage: React.FC<TabbedPageProps> = process.env.NODE_ENV === "production"
  ? NullComponent
  : function TabbedPage({ components }: TabbedPageProps) {
    return (
